<!-- controls myNote page, form here users can delete/create/update new notes -->
<?php
            ...
            while ($userNotes->have_posts()) {
                ...
                <li data-id="<?php echo esc_attr(get_the_ID()); ?>">
                    <input readonly type="text" value="<?php
                                                        echo str_replace('Private: ', '', esc_attr(get_the_title()))  ?>" class="note-title-field">
                    ...
                    <textarea readonly name="" id="" cols="30" rows="10" class="note-body-field">
                        <?php echo esc_textarea(wp_strip_all_tags(get_the_content())); ?></textarea>
